...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        @stack('styles')
        <style>
             /* Example CSS to ensure submenu expands */
        ...
        {!! Toastr::message() !!}
         ...
         <script>
            function printPDF(pageId){
                ...
                WinPrint.document.write("<link rel=\"stylesheet\" href=\"{{asset('assets/css/main/app.css')}}\">");
         ...
         <script>
            $(document).ready(function() {
                // Find the active sidebar item based on the current URL
                var currentUrl = window.location.href;
                var activeItem = $(".sidebar-item a").filter(function() {
                    return this.href === currentUrl;
                });

                // If an active item is found, add the active class to its parent (sidebar item) and show the submenu
                if (activeItem.length) {
                    activeItem.closest(".sidebar-item").addClass("active");
                    activeItem.next(".submenu").show();
                } else {
