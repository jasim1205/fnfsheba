    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                ...
                <h3>Individual-Services-Middle</h3>
    ...
    <section class="section">
        <div class="card">
            <div class="card-header">
                <div class="row">
                    <div class="col-6">
                        <a class="btn btn-primary" href="{{route('individualmiddle.create')}}"><i class="fa fa-plus"></i></a>
                    </div>
                </div>
                    ...
                    <tr>
                        ...
                        <td class="white-space-nowrap">
                            <div class="btn-group" role="group">   
                                <a href="{{route('individualmiddle.edit',encryptor('encrypt',$p->id))}}">
