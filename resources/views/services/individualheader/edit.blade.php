...
@section('title',trans('Individual-services'))
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-content">
                <div class="card-body">
                    <form class="form" method="post" enctype="multipart/form-data" action="{{route('individualheader.update',encryptor('encrypt',$header->id))}}">
                        @csrf
                        @method('Patch')
                        <div class="row">
