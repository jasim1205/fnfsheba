...
<section>
    <div class="container-fluid">
        ...
        <div class="row bg-primary mt-1">
            ...
            <div class="col-md-3">
                <p class="text-end m-2" style="color: rgb(238, 255, 0)">Leave Approval</p>
            </div>
        </div>
        <div class="row mt-1" style="background-color: rgb(195, 244, 245)">
            <div class="col-md-10">
                <form action="">
            ...
            <div class="col-md-2">
                <button type="submit" class="bg-primary my-1 text-center px-4" style="border-radius: 10px; color: rgb(238, 255, 0)">Approve all</button>
            </div>
        </div>
    </div>
</section>
